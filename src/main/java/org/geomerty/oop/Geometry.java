...
public class Geometry {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Area of square is " + square1.calculateArea());
        System.out.println("Area of square is " + square1.calculateParimeter());
        ...
        System.out.println("Area of rectangle is " + rectangle1.calculateArea());
        System.out.println("Area of rectangle is " + rectangle1.calculateParimeter());
        ...
        System.out.println("Area of circle is " + circle1.calculateParimeter());
    }
}
